						...
						<ul class="actions vertical">
							<li><h5>회원정보수정</h5></li>
								...
								<form action= "UpdateService" method= "post">
									<li>접속한 Email : <%= loginMem.getEmail() %></li>
									<li><input type="password"  name="pw" placeholder="PW를 입력하세요" style="width: 500px; margin: 0 auto;"></li>
									<li><input type="text" name="tel" value="<%=loginMem.getTel() %>" placeholder="전화번호를 입력하세요" style="width: 500px; margin: 0 auto;"></li>
									<li><input type="text" name="address" value="<%=loginMem.getAddress() %>" placeholder="집주소를 입력하세요" style="width: 500px; margin: 0 auto;"></li>
